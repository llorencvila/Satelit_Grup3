//AQUEST CODI CONTÉ EL CÀLCUL I L'ENVIAMENT DE LA TEMPERATURA I HUMITAT MITJANES, TAMBÉ CONTÉ EL CODI REFERENT AL CANVI DE PERIODE D'ENVIAMENT DE DADES
from tkinter import *
...
def canvi_periodeHT(): ##Aquesta funció ha migrat a Send_Canvi_Frequencia
    ValorFreq = "periode" +fraseHTEntry.get()
    #mySerial.write(ValorFreq)
...
Iniciar_distButton = Button(button_dist_frame, text="Play", bg='#6BD66B', fg="white", font=("Arial", 20), command=resume_dist)
Iniciar_distButton.grid(row=0, column=0, padx=5, pady=5, sticky=N + S + E + W)

Parar_distButton = Button(button_dist_frame, text="Pausa", bg='#FFB74D', fg="white", font=("Arial", 20), command=stop_dist)
